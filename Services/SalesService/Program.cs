...
builder.Services.AddAuthorizationBuilder()
    .AddPolicy("sales.read", policy =>
        policy.RequireRole("super_admin", "manager", "support", "sales", "tenant"))
    .AddPolicy("sales.write", policy =>
        policy.RequireRole("super_admin", "manager", "support", "sales", "tenant"))
    .AddPolicy("sales.manage", policy =>
        policy.RequireRole("super_admin", "manager", "sales"))
    .AddPolicy("sales.internal.write", policy =>
