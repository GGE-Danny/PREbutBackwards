...
// Infrastructure (DbContext, Repositories, FileStorage)
...
builder.Services.AddAuthorizationBuilder()
    .AddPolicy("document.read", policy =>
        policy.RequireRole("super_admin", "manager", "support", "sales", "tenant"))
    .AddPolicy("document.write", policy =>
        policy.RequireRole("super_admin", "manager", "support", "sales", "tenant"))
    .AddPolicy("document.manage", policy =>
        policy.RequireRole("super_admin", "manager", "support"))
    .AddPolicy("document.internal.write", policy =>
